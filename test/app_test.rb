...
class AppTest < Minitest::Test
  ...
  def test_renders_discord_like_scrolling_shell
    Dir.mktmpdir do |dir|
      ...
      assert_includes response.body, "data-streaming-submit=\"follow_up\""
      assert_includes response.body, ">Queue follow-up</button>"
      refute_includes response.body, "streaming-behavior"
  ...
  def test_live_event_script_keeps_assistant_and_status_roles_separate
    Dir.mktmpdir do |dir|
      ...
      assert_includes APP_JAVASCRIPT, "submitStreamingBehavior(\"follow_up\")"
