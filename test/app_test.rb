...
class AppTest < Minitest::Test
  ...
  def test_renders_discord_like_scrolling_shell
    Dir.mktmpdir do |dir|
      ...
      assert_includes response.body, "jump-controls--message-nav"
      assert_includes response.body, "jump-to-first"
      assert_includes response.body, "jump-to-previous-user"
      assert_includes response.body, "jump-to-next-user"
  ...
  def test_live_event_script_keeps_active_sessions_pinned_after_layout
    Dir.mktmpdir do |dir|
      ...
      assert_includes response.body, "function previousUserMessageAboveViewport()"
      assert_includes response.body, "function nextUserMessageBelowViewport()"
      ...
      assert_includes response.body, "scrollToUserMessage(previousUserMessageAboveViewport())"
      assert_includes response.body, "scrollToUserMessage(nextUserMessageBelowViewport())"
